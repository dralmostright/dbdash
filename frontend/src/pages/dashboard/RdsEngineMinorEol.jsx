...
export default function RdsEngineMinorEol() {
    const [rdsenginemajoreol, setRdsEngineMajorEol] = useState({
        title: "RDS End of Life",
        subtitle: "Minor Ver",
        icon: "bi bi-database-exclamation text-secondary",
        loading: true,
        loaderloc: "div",
        count: null,
        percentage: "4%",
        ...
        linkpageurl: "/aws/rds/list-rds/eolminor",
        errorMessage: null
    });
    ...
    useEffect(() => {
        const loadRdsMajorEol = async () => {
            try {
                ...
                const res = await RdsApi.getRdsEol('minor');
                ...
                setRdsEngineMajorEol(prev => ({
                    ...prev,
                    errorMessage: "Failed to load Minor ver EOL",
                }));
            } finally {
                setRdsEngineMajorEol(prev => ({
                    ...prev,

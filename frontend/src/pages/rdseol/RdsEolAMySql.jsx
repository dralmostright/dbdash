...
export function RdsEolAMySql() {
  const pagetitle = {
    title: "End of Life",
    parent: "EOL",
    current: "Rds Aurora MySQL",
  };

  const engine='aurora-mysql'
  const macolumns = [
    { field: 'rds_ma_ver', header: 'Aurora MySQL major version', sortable: 'sortable', visible: 'y'},
...
const micolumns = [
    { field: 'rds_mi_ver', header: 'Aurora MySQL minor version', sortable: 'sortable', visible: 'y'},
  ...
  return (
    <>
      <title> DbDash - EOL Aurora MySQL</title>
      <Header />
      <Sidebar />

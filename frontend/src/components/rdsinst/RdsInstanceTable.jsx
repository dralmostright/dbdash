...
export default function RdsInstanceTable({ data , columns }) {
...
const header = <MultiSelect value={visibleColumns} options={columns} optionLabel="header" onChange={onColumnToggle} placeholder="Select Columns" className="w-full sm:w-20rem" display="chip" />;
        ...
        <div className="card-body">
          ...
          >
            ...
            <Column
              header="Actions"
              body={(data) => (
                <Link to={`/aws/rds/view-rds/${data.aid}/${data.riid}`} className="rds-action">
